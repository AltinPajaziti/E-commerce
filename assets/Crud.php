...
class Crud
{
    public function Create($table, $data)
    {
        ...
        if ($result) {
            echo "E dhena u shtua me sukses";
        } else {
...
// }
    ...
    public function Update($table , $data , $kushti=[]){
        ...
        if($rezultati){
            echo "E dhena u Nderrua me sukses" ;
        }
        else{
            echo "Error: " . mysqli_error($lidhe);
        }
...
$crud->Create('perdoruesi' , ['Emri'=>"Altin" , 'Mbiemri'=>"pajaziti" ,'Adresa'=>"viti" ,'Email'=>"altin.pajaziti.st@uni-gjilan.net" , 'password'=>"altini123"]);
